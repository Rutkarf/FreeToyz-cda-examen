...
@Autowired
    ToyzRepositoryModel toyzRepositoryModel;
...
String newpicture = toyzServiceModel.getName()+dateString;
    ...
    ToyzRepositoryModel toyzRepositoryModel = new ToyzRepositoryModel( toyzServiceModel.getName(), toyzServiceModel.getDescription(), toyzServiceModel.getCotation(), toyzServiceModel.getQuantite(),newpicture);
...
public boolean update (ToyzServiceModel toyzServiceModel) {
    ...
    if(!toyzRepository.findById(toyzServiceModel.getId().get() ).isEmpty()  )
    {
        ...
        String newpicture = toyzServiceModel.getName()+dateString;
        ToyzRepositoryModel toyzRepositoryModel = new ToyzRepositoryModel(toyzServiceModel.getId(),toyzServiceModel.getName(),toyzServiceModel.getDescription(),toyzServiceModel.getCotation(), toyzServiceModel.getQuantite(), newpicture);
